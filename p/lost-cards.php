                            ...
                            <div class="inner-column">
                                ...
                                <div class="text">
                                    <p style="font-size:18px;">
                                        ...
                                        If your <?= $pageTitle ?> Card has been lost or stolen, notify us immediately.

                                        Call at: +<?= $page['url_tel'] ?>                                        or send us an email at <?= $page['url_email'] ?>                                        24 hours, 7 days a week. </p>
                                </div>
                            </div>
                        </div>
